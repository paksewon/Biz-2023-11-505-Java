 ...
 * 
 * 2. 입력된 학생정보가 저장된 StudentDto 객체를 List<StudentDto> students 리스트에 추가하는 코드 작성
 * 
 * 3. 반복문을 사용하여 계속해서 학생정보를 입력받고 students 리스트에 add 하는 코드 추가
 * 학생정보를 입력하는 도중 QUIT 를 입력하면 입력을 종료 하기
 * 
 * 4. 학생정보를 입력받는 중 입력한 학번이 이미 있으면 "학번중복"을 출력하고 다시 입력 받기 (StudentService 클래스)
 */
...
////			String stDto = scan.nextLine();
//			if (stDto.equals("QUIT")) {
//				break;
//			}
//		}
