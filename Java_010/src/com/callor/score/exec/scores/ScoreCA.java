...
public class ScoreCA {
	public static void main(String[] args) {
		...
		for (int index = 0; index < 3; index++) { // 1번 국어점수 2번 영어 점수 3번 수학점수
			int stNum = index + 1;
			// 키보드로 입력 받은 데이터를
			int scoreKor = numService.inputNumber(stNum + "번의 국어점수", 50, 100);
			int scoreEng = numService.inputNumber(stNum + "번의 영어점수", 50, 100);
			int scoreMath = numService.inputNumber(stNum + "번의 수학점수", 50, 100);
