...
public class NumberService {
	 ...
	 * NullpointerException 이 발생한다 Exception 발생을 방지하기 위하여 scan.nextLine() 코드를 scan
	 * 초기화 코드 "scan = new Scanner(System.in)"을 실행 하여 scan 을 사용할 준비를 해주야 한다
	 * 
	...
	public void printAlgebra(int num1, int num2) { // 연산
		Line.sLine(50);
