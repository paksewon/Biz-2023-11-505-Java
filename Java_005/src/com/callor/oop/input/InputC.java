 ...
 * 하지만 이 method 들은 bug 가 있어서 작동이 잘못 되는 경우가 있따
 ...
 * 이떄 Integer.valueOf(), Float.valueOf(), Long.valueOf(), Doulbe.valueOf()등 
 * method 를 사용하여 문자열형 숫자를 실제 숫자로 변환한다
 * 
 * Integer.parseInt(), Integer.valueOf()
 * Long.paseLong(), Double.parseDouble() 등의 method 도 있다
 */
public class InputC {
	public static void main(String[] args) {
		...
		System.out.println("두개의 정수를 입력 받아");
		System.out.println("사칙연산을 수행합니다");
		System.out.println("두개의 정수를 입력해 주세요");
		
		System.out.print("정수 1 >> ");
		String str1 = scan.nextLine();
		num1 = Integer.parseInt(str1); // static 메서드
		Float.parseFloat(str1); // 뒤에 똑같이 붙혀야한다
		
		System.out.print("정수 2 >> ");
		String str2 = scan.nextLine(); // non-static 메서드
