...
public class MainExB {
	 ...
	 * 클래스의 객체 실행될때 다른 클래스의 객체를 연결하여 
	 * 사용해야 하는 경우 보통은 각 클래스에서 다른 클래스의 객체를 생성하여
	 * 사용하는데, 그러한 코드는 결합도가 매우 높아진다
	 * 하지만 인터페이스를 매개변수로 하고, 생성자를 통하여 생성된 객체를
	 * 주입하면 결합도를 매우 낮출수 있다.
	 * 
	 * 소프트웨어 공학에 디자인 패턴 14가지가 있는데 
	 * 그중 전략패턴을 적용한 것
	 * 
	 */
	public static void main(String[] args) {
		String stDataFile = "src/com/callor/student/data/student.txt";
		StudentService stService = new StudentServiceImplV2(stDataFile);
